...
2. Run: `Invoke-ScriptAnalyzer -Path .\test.ps1 -CustomRulePath .\CustomRules`
3. Error occurs: ...
...
**Common Changes**:
- Add/modify custom rules: Edit `CustomRules/CustomRules.psm1`
- Add/modify built-in rule config: Edit `PSScriptAnalyzerSettings.psd1`
...
Add to the `Export-ModuleMember` at the end of `CustomRules.psm1`:
...
Describe "Measure-AcronymCasing" {
    It "Detects incorrect 2-letter acronym casing" {
        ...
        $Results = Invoke-ScriptAnalyzer -ScriptDefinition $Script -CustomRulePath .\CustomRules
